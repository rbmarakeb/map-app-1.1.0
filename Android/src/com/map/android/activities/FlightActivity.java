...
public class FlightActivity extends DrawerNavigationUI implements SlidingUpPanelLayout.PanelSlideListener {
    ...
    private static FlightDataFragment flightData;
    private static Fragment actionBarTelem;
    ...
    //this function used to access to ActionBarTelemFragment Instance
    public static ActionBarTelemFragment getInstance(){
        return (ActionBarTelemFragment) actionBarTelem;
    }
    //this function used to access to RemoteHelmDataFragment Instance
    public static FlightDataFragment getFlightDataInstance(){
        return flightData;
    }
    @Override
    ...
    protected void addToolbarFragment() {
        ...
        final FragmentManager fm = getSupportFragmentManager();
        actionBarTelem = fm.findFragmentById(toolbarId);
