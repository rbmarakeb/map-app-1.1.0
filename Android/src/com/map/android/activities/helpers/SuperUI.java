package com.map.android.activities.helpers;
...
import com.map.android.dialogs.SlideToUnlockDialog;
import com.map.android.dialogs.SupportYesNoWithPrefsDialog;
...
import com.map.android.AppService;
...
import com.map.android.fragments.actionbar.VehicleStatusFragment;
...
public abstract class SuperUI extends AppCompatActivity implements DroidPlannerApp.ApiListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
		 ...
		 * com.map.android.service .MAVLinkService) as suggested by the
...
//        builder.setMessage("DO NOT OPERATE IN WATER CHANNELS, MARINAS OR SHALLOW AREAS\n NEVER LEAVE HELM UNATTENDED");
//// Set up the buttons
