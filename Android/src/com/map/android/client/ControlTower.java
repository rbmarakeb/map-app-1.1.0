...
import com.map.android.client.apis.ApiAvailability;
    ...
    public void connect(TowerListener listener) {
        ...
        if (!isTowerConnected() && !isServiceConnecting.get()) {
            ...
            switch(apiAvailableResult){
                ...
                default:
//                    context.startService(new Intent(context, DroidPlannerService.class));
//                    bindService(new Intent(getApplicationContext(), DroidPlannerService.class), o3drServicesConnection,
//                            Context.BIND_AUTO_CREATE);
