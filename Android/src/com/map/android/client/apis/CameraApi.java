...
import static com.map.android.lib.drone.action.CameraActions.ACTION_START_VIDEO_STREAM;
import static com.map.android.lib.drone.action.CameraActions.ACTION_STOP_VIDEO_STREAM;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_DISPLAY;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_ENABLE_LOCAL_RECORDING;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_LOCAL_RECORDING_FILENAME;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_PROPS_UDP_PORT;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_TAG;
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_PROPERTIES;
