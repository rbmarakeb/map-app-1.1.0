...
import com.map.android.client.utils.connection.IpConnectionListener;
import com.map.android.client.utils.connection.UdpConnection;
import com.map.android.lib.coordinate.LatLongAlt;
import com.map.android.lib.drone.action.ExperimentalActions;
...
import static com.map.android.lib.drone.action.CameraActions.EXTRA_VIDEO_TAG;
import static com.map.android.lib.drone.action.ExperimentalActions.ACTION_SEND_MAVLINK_MESSAGE;
import static com.map.android.lib.drone.action.ExperimentalActions.ACTION_SET_RELAY;
import static com.map.android.lib.drone.action.ExperimentalActions.ACTION_SET_ROI;
import static com.map.android.lib.drone.action.ExperimentalActions.ACTION_SET_SERVO;
import static com.map.android.lib.drone.action.ExperimentalActions.ACTION_TRIGGER_CAMERA;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_IS_RELAY_ON;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_MAVLINK_MESSAGE;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_RELAY_NUMBER;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_SERVO_CHANNEL;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_SERVO_PWM;
import static com.map.android.lib.drone.action.ExperimentalActions.EXTRA_SET_ROI_LAT_LONG_ALT;
