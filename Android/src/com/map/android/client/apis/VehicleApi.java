...
import static com.map.android.lib.drone.action.ConnectionActions.ACTION_CONNECT;
import static com.map.android.lib.drone.action.ConnectionActions.ACTION_DISCONNECT;
import static com.map.android.lib.drone.action.ConnectionActions.EXTRA_CONNECT_PARAMETER;
import static com.map.android.lib.drone.action.ParameterActions.ACTION_REFRESH_PARAMETERS;
import static com.map.android.lib.drone.action.ParameterActions.ACTION_WRITE_PARAMETERS;
import static com.map.android.lib.drone.action.ParameterActions.EXTRA_PARAMETERS;
import static com.map.android.lib.drone.action.StateActions.ACTION_ARM;
import static com.map.android.lib.drone.action.StateActions.ACTION_ENABLE_RETURN_TO_ME;
import static com.map.android.lib.drone.action.StateActions.ACTION_SET_VEHICLE_HOME;
import static com.map.android.lib.drone.action.StateActions.ACTION_SET_VEHICLE_MODE;
import static com.map.android.lib.drone.action.StateActions.ACTION_UPDATE_VEHICLE_DATA_STREAM_RATE;
import static com.map.android.lib.drone.action.StateActions.EXTRA_ARM;
import static com.map.android.lib.drone.action.StateActions.EXTRA_EMERGENCY_DISARM;
import static com.map.android.lib.drone.action.StateActions.EXTRA_IS_RETURN_TO_ME_ENABLED;
import static com.map.android.lib.drone.action.StateActions.EXTRA_VEHICLE_DATA_STREAM_RATE;
import static com.map.android.lib.drone.action.StateActions.EXTRA_VEHICLE_HOME_LOCATION;
import static com.map.android.lib.drone.action.StateActions.EXTRA_VEHICLE_MODE;
