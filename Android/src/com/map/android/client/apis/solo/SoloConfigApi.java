...
import com.map.android.lib.drone.companion.solo.controller.SoloControllerMode;
import com.map.android.lib.drone.companion.solo.controller.SoloControllerUnits;
import com.map.android.lib.drone.companion.solo.tlv.SoloButtonSettingSetter;
import com.map.android.lib.model.AbstractCommandListener;
import com.map.android.lib.model.action.Action;

import java.util.concurrent.ConcurrentHashMap;

import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_REFRESH_SOLO_VERSIONS;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_BUTTON_SETTINGS;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_MODE;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_UNIT;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_TX_POWER_COMPLIANCE_COUNTRY;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_WIFI_SETTINGS;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_BUTTON_SETTINGS;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_MODE;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_UNIT;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_TX_POWER_COMPLIANT_COUNTRY_CODE;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_PASSWORD;
import static com.map.android.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_SSID;
...
public class SoloConfigApi extends SoloApi {
     ...
     *
     * @param controllerMode Controller mode. @see {@link com.map.android.lib.drone.companion.solo.controller.SoloControllerMode.ControllerMode}
     * @param listener       Register a callback to receive update of the command execution status.
     */
     ...
     * @param controllerUnit Controller unit system. @see {@link com.map.android.lib.drone.companion.solo.controller.SoloControllerUnits.ControllerUnit}
