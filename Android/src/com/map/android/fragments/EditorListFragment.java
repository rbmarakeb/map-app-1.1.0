...
import com.map.android.view.adapterViews.MissionItemListAdapter;
...
public class EditorListFragment extends ApiListenerFragment implements MissionSelection.OnSelectionUpdateListener {
    ...
    private final BroadcastReceiver eventReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ((MissionItemListAdapter)recyclerAdapter).missionItemProxyList.clear();
            missionProxy.selection.clearSelection();
            ((MissionItemListAdapter)recyclerAdapter).missionItemProxyList.addAll(missionProxy.getItems());
            ((MissionItemListAdapter)recyclerAdapter).missionItemProxyList.add(new MissionItemProxy());
