...
public class FlightDataFragment extends ApiListenerFragment implements SlidingDrawer.OnDrawerOpenListener, SlidingDrawer.OnDrawerCloseListener {
    ...
    private static View warningContainer;
    ...
    private static SlidingUpPanelLayout mSlidingPanel;
    ...
    //this function used to access to SlidingUpPanelLayout Instance
    public static SlidingUpPanelLayout getSlidingUpPaneInstance(){
        return mSlidingPanel;
    }
    public  FlightMapFragment getFlightMapFragmentInstance(){
        return mapFragment;
    }
    ...
    public static void showWarningView(){
        warningText.setText("Slow Down below 15 knots to Engage AUTO MODE");
