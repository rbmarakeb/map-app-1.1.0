...
import com.map.android.proxy.mission.item.adapters.AdapterMissionItems;
import com.map.android.view.button.RadioButtonCenter;
...
public class EditorToolsFragment extends ApiListenerFragment implements OnClickListener, SupportYesNoDialog.Listener {
    ...
    public enum EditorTools {
        MARKER, POI, DRAW, TRASH, SELECTOR, NONE
    }
...

    {
        ...
        editorToolsImpls[EditorTools.POI.ordinal()] = new POIToolsImpl(this);
    ...
    TextView pointOfInterest, selectAll, clearSelected, clearMission;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final RadioButtonCenter buttonPOI = (RadioButtonCenter) view.findViewById(R.id.editor_tools_poi);
        final POIToolsImpl poiToolImpl = (POIToolsImpl) editorToolsImpls[EditorTools.POI.ordinal()];
        pointOfInterest = (TextView) view.findViewById(R.id.point_of_interest);
        pointOfInterest.setOnClickListener(poiToolImpl);
        ...
        for (View vv : new View[]{buttonMarker, buttonPOI, buttonDraw, buttonTrash, buttonSelector}) {
    ...
    private void hideSubTools() {
        ...
        if (pointOfInterest != null)
            pointOfInterest.setVisibility(View.GONE);
    ...
    public void setToolAndUpdateView(EditorTools tool) {
        if (this.getTool() != EditorTools.POI)
            setTool(tool, false);
    ...
    private EditorTools getToolForView(int viewId) {
        switch (viewId) {
            ...
            case R.id.editor_tools_poi:
                return EditorTools.POI;
