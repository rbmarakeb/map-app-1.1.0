package com.map.android.lib.drone.companion.solo;
...
public class SoloEventExtras {
    ...
    private static final String PACKAGE_NAME = "com.map.android.lib.drone.companion.solo.event.extra";

    /**
     * Used to retrieve the {@link com.map.android.lib.drone.companion.solo.button.ButtonPacket} object describing the button event.
     */
     ...
     * @see {@link com.map.android.lib.drone.companion.solo.controller.SoloControllerMode.ControllerMode}
     ...
     * @see {@link com.map.android.lib.drone.companion.solo.controller.SoloControllerUnits.ControllerUnit}
