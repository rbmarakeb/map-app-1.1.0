package com.map.android.lib.gcs.link;
 ...
 * <p/>
 * This value is returned in the {@link com.map.android.client.Drone#notifyAttributeUpdated} as the
 * extra value {@link com.map.android.lib.gcs.link.LinkEventExtra#EXTRA_CONNECTION_STATUS}
 * when the attribute event is {@link com.map.android.lib.gcs.link.LinkEvent#LINK_STATE_UPDATED}
 */
