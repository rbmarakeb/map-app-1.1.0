...
import com.map.android.dialogs.EditInputDialog
import com.map.android.maps.providers.DPMapProvider
import com.map.android.maps.providers.MapProviderPreferences
import com.map.android.maps.providers.google_map.GoogleMapPrefConstants.*
...
class GoogleMapPrefFragment : MapProviderPreferences(), EditInputDialog.Listener {
    ...
    private fun enableTileProvider(tileProviderPref: ListPreference?, provider: String, persistPreference: Boolean){
       ...
       tileProviderPref?.summary = "Enable/Disable Offline Maps"
    ...
    private fun setupTileProvidersPreferences(sharedPref: SharedPreferences) {
        ...
        if(tileProvidersPref != null){
            ...
            tileProvidersPref?.summary = "Enable/Disable Offline Maps"
    ...
    private fun setupGoogleTileProviderPreferences(sharedPref: SharedPreferences) {
        ...
        mapTypePref?.let {
            mapTypePref.summary = "Google Maps"//sharedPref.getString(mapTypeKey, DEFAULT_MAP_TYPE)
            mapTypePref.setOnPreferenceChangeListener { preference, newValue ->
                mapTypePref.summary = "Google Maps"
                true
            }
        }
    }
    ...
    private fun setupArcGISTileProviderPreferences(sharedPref: SharedPreferences){
        ...
        val mapTypePref = findPreference(mapTypeKey)
        mapTypePref?.let {
            mapTypePref.summary = "Offline Maps"//sharedPref.getString(mapTypeKey, getString(DEFAULT_ARCGIS_MAP_TYPE))
            mapTypePref.setOnPreferenceChangeListener { preference, newValue ->
                mapTypePref.summary = "Offline Maps"
                true
            }
        }
