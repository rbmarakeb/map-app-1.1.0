package com.map.android.proxy.mission.item;
 ...
 * {@link com.map.android.lib.drone.mission.item.MissionItem} class on the Android layer,
...
public class MissionItemProxy {
	...
	public MissionItemProxy() {
		this.stableId = System.nanoTime();
		mMission = null;
		mMissionItem = null;
		mMarkerInfos = new ArrayList<>();
	}
	 ...
	 * 
	 * @return {@link com.map.android.lib.drone.mission.item.MissionItem} object
	 */
