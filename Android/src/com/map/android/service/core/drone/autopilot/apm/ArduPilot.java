...
import com.map.android.lib.drone.action.ParameterActions;
...
import com.map.android.lib.drone.mission.action.MissionActions;
...
import com.map.android.lib.gcs.action.CalibrationActions;
...
import com.map.android.service.core.MAVLink.MavLinkParameters;
...
import com.map.android.service.core.drone.autopilot.apm.variables.APMHeartBeat;
...
import com.map.android.service.core.drone.variables.HeartBeat;
import com.map.android.service.core.drone.variables.Magnetometer;
import com.map.android.service.core.drone.variables.RC;
...
public abstract class ArduPilot extends GenericMavLinkDrone {
    ...
    private final com.map.android.service.core.drone.variables.RC rc;
    ...
    public boolean executeAsyncAction(Action action, final ICommandListener listener) {
        ...
        switch (type) {
            ...
            case MissionActions.ACTION_SET_MISSION:
                data.setClassLoader(com.map.android.lib.drone.mission.Mission.class.getClassLoader());
                com.map.android.lib.drone.mission.Mission mission = data.getParcelable(MissionActions.EXTRA_MISSION);
            ...
            case ParameterActions.ACTION_WRITE_PARAMETERS:
                data.setClassLoader(com.map.android.lib.drone.property.Parameters.class.getClassLoader());
                com.map.android.lib.drone.property.Parameters parameters = data.getParcelable(ParameterActions.EXTRA_PARAMETERS);
