package com.map.android.service.core.gcs.location;
...
import com.map.android.service.core.gcs.location.Location.LocationFinder;
...
public class FusedLocation extends LocationCallback implements LocationFinder, GoogleApiClientManager.ManagerListener {
    ...
    public void onLocationResult(LocationResult result) {
        ...
        com.map.android.service.core.gcs.location.Location location =
                new com.map.android.service.core.gcs.location.Location(
                new LatLongAlt(
    ...
    private void notifyLocationUpdate(com.map.android.service.core.gcs.location.Location location) {
