...
import com.map.android.lib.drone.calibration.magnetometer.MagnetometerCalibrationProgress;
import com.map.android.lib.drone.calibration.magnetometer.MagnetometerCalibrationResult;
...
import com.map.android.lib.drone.mission.item.complex.CameraDetail;
...
import com.map.android.lib.drone.property.Vibration;
...
import com.map.android.service.core.drone.autopilot.Drone;
import com.map.android.service.core.drone.autopilot.MavLinkDrone;
import com.map.android.service.core.drone.autopilot.apm.ArduPilot;
...
//                return VehicleMode.ROVER_INITIALIZING;
    ...
    public static State getState(MavLinkDrone drone, boolean isConnected, Vibration vibration) {
        ...
        com.map.android.service.core.drone.variables.State droneState = drone.getState();
    ...
    public static Mission getMission(MavLinkDrone drone) {
        ...
        com.map.android.service.core.mission.Mission droneMission = drone.getMission();
    ...
    public static void arm(final ArduPilot drone, final boolean arm, final boolean emergencyDisarm, final ICommandListener listener) {
        ...
        if (!arm && emergencyDisarm) {
            if (com.map.android.service.core.drone.variables.Type.isCopter(drone.getType()) && !isKillSwitchSupported(drone)) {
    ...
    public static boolean isKillSwitchSupported(MavLinkDrone drone) {
        ...
        if (!com.map.android.service.core.drone.variables.Type.isCopter(drone.getType()))
            return false;
    ...
    public static Survey buildSurvey(MavLinkDrone drone, Survey survey) {
        com.map.android.service.core.mission.Mission droneMission = drone == null ? null : drone.getMission();
