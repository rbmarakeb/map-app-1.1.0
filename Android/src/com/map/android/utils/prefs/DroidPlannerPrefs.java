package com.map.android.utils.prefs;
...
import com.map.android.fragments.widget.video.WidgetVideoPreferences;
...
public class DroidPlannerPrefs {
    ...
    public static final String PREF_JOYSTIC_CHANNEL = "pref_joystic_channel";
    ...
    private static final String PREF_HOME_MARKER_ENABLED = "pref_home_marker_enabled";
    ...
    public String getJoystickChannel() {
        String channel = prefs.getString(PREF_JOYSTIC_CHANNEL, null);
        if (channel == null)
            return "Channel 1";
    ...
    public void setHomeMarkerEnabled(boolean enabled){
        prefs.edit().putBoolean(PREF_HOME_MARKER_ENABLED, enabled).apply();
    }

    public boolean getHomeMarkerEnabled() {
        return prefs.getBoolean(PREF_HOME_MARKER_ENABLED, false);
    }
}
